...
<div class="flex mx-auto max-w-200 opacity-100 relative z-20">       
    ...
    <a href="{{ route('workers.index') }}" class="flex-1 m-3 text-white border border-black bg-[#6ADA6E] rounded-[7px] py-1 px-3 font-bold cursor-pointer text-center">Trabajadores</a>
    ...
    <a href="{{ route('plan.form') }}" class="flex-1 m-3 text-white border border-black bg-[#6ADA6E] rounded-[7px] py-1 px-3 font-bold cursor-pointer text-center">Actividades</a>
</div>
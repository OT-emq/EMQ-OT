...
@section('title', 'Formulario plan')

@section('content')
    <div class="max-w-7xl mx-auto mt-8">

        <h1 class="bg-blue-500 text-white text-4xl rounded-lg p-4 text-center font-bold border border-black mb-8">
            ...
            <form>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" class="w-full border rounded-lg p-3 mt-2">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full border rounded-lg p-3 mt-2">
                    ...
                    <div>
                        ...
                        <select class="w-full border rounded-lg p-3 mt-2">
                ...
                <div class="mt-6">
                    ...
                    <textarea rows="5" class="w-full border rounded-lg p-3 mt-2"></textarea>
        ...
        <div class="flex justify-end mt-8">
            ...
            <a href="" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg">
